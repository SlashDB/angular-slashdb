            ...
            <div class="panel panel-default"> \
                ...
                <div class="panel-body"> \
                    <form ng-submit="$ctrl.applyFilters()"> \
                        <div class="form-group"> \
                            <label class="sr-only" for="filterBy">Filter visible by</label> \
                            <div class="input-group input-group-sm"> \
                                <input type="text" min="0" class="form-control" id="filterBy" placeholder="filter visible by" ng-model="$ctrl.tableData.filterBy"> \
                        ...
                        <div class="form-group"> \
                            <label class="sr-only" for="Limit">Limit to</label> \
                            <div class="input-group input-group-sm"> \
                        ...
                        <div class="form-group"> \
                            <label class="sr-only" for="Offset">Offset by</label> \
                            <div class="input-group input-group-sm"> \
        ...
        .component('artistPanel', {
            ...
            <div ng-cloak ng-show="$ctrl.credentials.isAuthenticated()"> \
                ...
                <table class="table table-striped table-bordered table-hover"> \
                    ...
                    <tbody> \
                        <tr ng-repeat="artist in $ctrl.tableData.data | filter:{Name: $ctrl.tableData.filterBy} track by $index"> \
            ...
            <div class="panel panel-default"> \
                ...
                <div class="panel-body"> \
                    <form ng-submit="$ctrl.addArtist()"> \
                        <div class="form-group"> \
                            <label class="sr-only" for="Name">Artists name</label> \
