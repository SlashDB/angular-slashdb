    ...
    var exampleApp = angular.module('exampleApp', ['angularSlashDB'])
        ...
        .component('filterBar', {
            ...
            <form class="form-inline" ng-submit="$ctrl.applyFilters()"> \
                ...
                <button type="submit" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Apply</button> \
            </form> \
            <br/> \
            ',
            ...
            controller: function (tableData, artistDataConfig, slashDB) {
                ...
                ctrl.addArtist = function () {
                    if (ctrl.artist.Name != null && ctrl.artist.Name != '') {
                        slashDB.post(artistDataConfig.url, ctrl.artist).then(
                            function (response) {
                                ctrl.artist = '';
                                tableData.getData(artistDataConfig);
                            },
